            ...
            <ul class="navbar-list">
                ...
                <li class="navbar-item dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="/typeComposants/form" class="dropdown-item">Type Composant</a>
                        ...
                        <a href="/composantModeles/form" class="dropdown-item">Composant Modèle</a>
                        <a href="/mvtStocks/form" class="dropdown-item">Mvt Stock</a>
                    </div>
                </li>
                ...
                <li class="navbar-item dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="/typeComposants" class="dropdown-item">Type Composant</a>
                        ...
                        <a href="/composantModeles" class="dropdown-item">Composant Modèle</a>
                        <a href="/mvtStocks" class="dropdown-item">Mvt Stock</a>
                    </div>
                </li>
            </ul>
        </div>
